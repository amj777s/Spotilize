...
export default function PlaylistPanel({
    ...
    return (
        <div className="snap-center max-w-xl w-full h-full overflow-y-auto inline-flex flex-col mr-4 gap-2 p-2 border-green-400 border-4 rounded-lg accent-green-400">
